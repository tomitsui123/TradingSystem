...
namespace TradingSystem_final {
    ...
    public partial class Database1DataSet3 : global::System.Data.DataSet {
        ...
        public partial class AccountDataTable : global::System.Data.TypedTableBase<AccountRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public AccountRow AddAccountRow(string Name, int AccountNo, int Balance) {
            ...
            public int Balance {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("資料表 \'Account\' 中資料行 \'Balance\' 的值是 DBNull。", e);
                    }
                }
                set {
...
namespace TradingSystem_final.Database1DataSet3TableAdapters {
    ...
    public partial class AccountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Account] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_" +
                "Name) AND ([AccountNo] = @Original_AccountNo) AND ((@IsNull_Balance = 1 AND [Bal" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Account] ([Name], [AccountNo], [Balance]) VALUES (@Name, @Acco" +
                "untNo, @Balance);\r\nSELECT Id, Name, AccountNo, Balance FROM Account WHERE (Id = " +
                "SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Account] SET [Name] = @Name, [AccountNo] = @AccountNo, [Balance] = @Balance WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([AccountNo] = @Original_AccountNo) AND ((@IsNull_Balance = 1 AND [Balance] IS NULL) OR ([Balance] = @Original_Balance)));
SELECT Id, Name, AccountNo, Balance FROM Account WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, AccountNo, Balance FROM dbo.Account";
        ...
        public virtual int Fill(Database1DataSet3.AccountDataTable dataTable) {
        ...
        public virtual Database1DataSet3.AccountDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet3.AccountDataTable dataTable = new Database1DataSet3.AccountDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet3.AccountDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, int Original_AccountNo, global::System.Nullable<int> Original_Balance) {
        ...
        public virtual int Insert(string Name, int AccountNo, global::System.Nullable<int> Balance) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, int AccountNo, global::System.Nullable<int> Balance, int Original_Id, string Original_Name, int Original_AccountNo, global::System.Nullable<int> Original_Balance, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int AccountNo, global::System.Nullable<int> Balance, int Original_Id, string Original_Name, int Original_AccountNo, global::System.Nullable<int> Original_Balance) {
            return this.Update(Name, AccountNo, Balance, Original_Id, Original_Name, Original_AccountNo, Original_Balance, Original_Id);
        }
    }
