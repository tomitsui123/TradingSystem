...
namespace TradingSystem_final {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class AccountDataTable : global::System.Data.TypedTableBase<AccountRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public AccountRow AddAccountRow(string Name, int Balance) {
...
namespace TradingSystem_final.Database1DataSetTableAdapters {
    ...
    public partial class AccountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Account] WHERE (([ID] = @Original_ID) AND ([Name] = @Original_" +
                "Name) AND ([Balance] = @Original_Balance))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Account] ([ID], [Name], [Balance]) VALUES (@ID, @Name, @Balanc" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Account] SET [ID] = @ID, [Name] = @Name, [Balance] = @Balance WHERE" +
                " (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Balance] = @Original" +
                "_Balance));\r\nSELECT ID, Name, Balance FROM Account WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Balance FROM dbo.Account";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, int Original_Balance) {
        ...
        public virtual int Insert(int ID, string Name, int Balance) {
        ...
        public virtual int Update(int ID, string Name, int Balance, int Original_ID, string Original_Name, int Original_Balance) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Balance, int Original_ID, string Original_Name, int Original_Balance) {
            return this.Update(Original_ID, Name, Balance, Original_ID, Original_Name, Original_Balance);
        }
    }
